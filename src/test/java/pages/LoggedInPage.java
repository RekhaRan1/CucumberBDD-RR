...
public class LoggedInPage extends BrowserDriver {
    ...
    public static void visibility_productcategory_formalshoes() throws InterruptedException {
        String actualproductcategory_ss = driver.findElement(By.xpath(productcategory_formalshoes)).getText();
        assertEquals("Formal Shoes", actualproductcategory_ss);
    }
    public static void visibility_productcategory_sportsshoes() throws InterruptedException {
        String actualproductcategory_s = driver.findElement(By.xpath(productcategory_sportsshoes)).getText();
        assertEquals("Sports", actualproductcategory_s);
    }

    public static void visibility_productcategory_sneakershoes() throws InterruptedException {
        String actualproductcategory_fs = driver.findElement(By.xpath(productcategory_sneakershoes)).getText();
        assertEquals("Sneakers", actualproductcategory_fs);
    }
